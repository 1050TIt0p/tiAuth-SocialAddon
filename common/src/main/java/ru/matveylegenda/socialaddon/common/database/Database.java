...
public class Database {
    ...
    public Database(ru.matveylegenda.tiauth.database.Database authDatabase, DataSource dataSource, ExecutorService executor) throws SQLException {
        this.authDatabase = authDatabase;
        this.discordUserRepository = new DiscordUserRepository(dataSource, executor);
        this.telegramUserRepository = new TelegramUserRepository(dataSource, executor);
    }
}
