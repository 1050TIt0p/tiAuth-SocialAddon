...
public class TelegramConfig extends YamlSerializable {
    ...
    @Transient
    public static final TelegramConfig IMP = new TelegramConfig();

    public TelegramConfig() {
        super(Paths.get("plugins/tiAuth-SocialAddon/socials/telegram.yml"), CONFIG);
    ...
    public static class Messages {
        ...
        public Messages.TwoFaAlert twoFaAlert;
        public static class TwoFaAlert {
            public String message = "Подтвердите вход на сервер\n\nАккаунт: {player}\nIP: {ip}";

            public Messages.TwoFaAlert.Buttons buttons;
            public static class Buttons {
                public Messages.TwoFaAlert.Buttons.Allow allow;
                public static class Allow {
                    public String text = "✅ Подтвердить";
                }

                public Messages.TwoFaAlert.Buttons.Deny deny;
