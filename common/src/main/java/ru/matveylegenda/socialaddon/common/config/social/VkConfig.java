...
public class VkConfig extends YamlSerializable {
    ...
    @Transient
    public static final VkConfig IMP = new VkConfig();

    public VkConfig() {
        super(Paths.get("plugins/tiAuth-SocialAddon/socials/vk.yml"), CONFIG);
    ...
    public static class Messages {
        ...
        public String accountLimitReached = "К вашему VK привязано максимальное количество аккаунтов";

        public String codeAccept = "Код принят. Для завершения привязки напишите на сервере: /link accept";
        public String accountUnlinked = "Аккаунт {player} успешно отвязан от вашего VK";
